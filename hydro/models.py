...
class News(models.Model):
    ...
    news_anno = models.CharField(max_length=-1, blank=True, null=True)
...
class RegistrationArticle(models.Model):
    ...
    fio = models.CharField(db_column='FIO', max_length=1000, blank=True, null=True)  # Field name made lowercase.
